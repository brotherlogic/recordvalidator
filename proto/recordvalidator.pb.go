...
type Scheme struct {
	...
	CompletedIds   []int64           `protobuf:"varint,4,rep,packed,name=completed_ids,json=completedIds,proto3" json:"completed_ids,omitempty"`
	CurrentPick    int64             `protobuf:"varint,5,opt,name=current_pick,json=currentPick,proto3" json:"current_pick,omitempty"`
	...
	CompleteDate   map[int64]int64   `protobuf:"bytes,9,rep,name=complete_date,json=completeDate,proto3" json:"complete_date,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	Ordering       map[int64]float32 `protobuf:"bytes,10,rep,name=ordering,proto3" json:"ordering,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
	Active         bool              `protobuf:"varint,11,opt,name=active,proto3" json:"active,omitempty"`
	LastValidation int64             `protobuf:"varint,12,opt,name=last_validation,json=lastValidation,proto3" json:"last_validation,omitempty"`
}
...
func (x *Scheme) GetInstanceIds() []int64 {
	if x != nil {
...
func (x *Scheme) GetCompletedIds() []int64 {
	if x != nil {
...
func (x *Scheme) GetCurrentPick() int64 {
	if x != nil {
...
func (x *Scheme) GetCompleteDate() map[int64]int64 {
	if x != nil {
...
func (x *Scheme) GetOrdering() map[int64]float32 {
	if x != nil {
		return x.Ordering
	}
	return nil
...
func (x *Scheme) GetLastValidation() int64 {
	if x != nil {
...
func (x *GetSchemeRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *ForceRequest) Reset() {
	*x = ForceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_recordvalidator_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ForceRequest) Descriptor() ([]byte, []int) {
	return file_recordvalidator_proto_rawDescGZIP(), []int{4}
}

func (x *ForceRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ForceResponse) Reset() {
	*x = ForceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_recordvalidator_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ForceResponse) Descriptor() ([]byte, []int) {
	return file_recordvalidator_proto_rawDescGZIP(), []int{5}
}
...
var file_recordvalidator_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x6d, 0x65, 0x73, 0x22, 0x9b, 0x05, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d,
	...
	0x5f, 0x69, 0x64, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0b, 0x69, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x70, 0x6c,
	0x65, 0x74, 0x65, 0x64, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x03, 0x52, 0x0c,
	...
	0x28, 0x03, 0x52, 0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x50, 0x69, 0x63, 0x6b, 0x12,
	...
	0x08, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x6c, 0x61, 0x73,
	0x74, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0e, 0x6c, 0x61, 0x73, 0x74, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x1a, 0x3f, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x61,
	...
	0x02, 0x38, 0x01, 0x1a, 0x3b, 0x0a, 0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x45,
	...
	0x22, 0x42, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0a, 0x0a, 0x06, 0x52, 0x41, 0x4e,
	0x44, 0x4f, 0x4d, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x10, 0x01,
	0x12, 0x11, 0x0a, 0x0d, 0x52, 0x45, 0x56, 0x45, 0x52, 0x53, 0x45, 0x5f, 0x4f, 0x52, 0x44, 0x45,
	0x52, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x47, 0x49, 0x56, 0x45, 0x4e, 0x5f, 0x4f, 0x52, 0x44,
	0x45, 0x52, 0x10, 0x03, 0x22, 0x47, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x05, 0x46, 0x6f, 0x72,
	0x63, 0x65, 0x12, 0x1d, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x76, 0x61, 0x6c, 0x69, 0x64,
	0x61, 0x74, 0x6f, 0x72, 0x2e, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x1e, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x6f, 0x72, 0x2e, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x70,
...
var file_recordvalidator_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_recordvalidator_proto_goTypes = []interface{}{
	...
	(*ForceRequest)(nil),      // 5: recordvalidator.ForceRequest
	(*ForceResponse)(nil),     // 6: recordvalidator.ForceResponse
	nil,                       // 7: recordvalidator.Scheme.CompleteDateEntry
	nil,                       // 8: recordvalidator.Scheme.OrderingEntry
}
var file_recordvalidator_proto_depIdxs = []int32{
	...
	7, // 2: recordvalidator.Scheme.complete_date:type_name -> recordvalidator.Scheme.CompleteDateEntry
	8, // 3: recordvalidator.Scheme.ordering:type_name -> recordvalidator.Scheme.OrderingEntry
	...
	5, // 6: recordvalidator.RecordValidatorService.Force:input_type -> recordvalidator.ForceRequest
	4, // 7: recordvalidator.RecordValidatorService.GetScheme:output_type -> recordvalidator.GetSchemeResponse
	6, // 8: recordvalidator.RecordValidatorService.Force:output_type -> recordvalidator.ForceResponse
...
func file_recordvalidator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_recordvalidator_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_recordvalidator_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
